...
- [x] **Step 1: Update the test with the new contract**
...
- [x] **Step 3: Commit the failing contract together with Task 2 implementation**
...
- [x] **Step 1: Rename the visual depth state without changing gesture math**
...
- [x] **Step 2: Replace the legacy pocket markup**
...
- [x] **Step 3: Build the full-width curved sheet extension**
...
- [x] **Step 4: Place the status inside the revealed garden region**
...
- [x] **Step 1: Build the deployment bundle**

Run: `npm run build`

Expected: `CloudBase bundle created at dist/cloudbase`.

- [x] **Step 2: Open the local preview at a mobile viewport**
...
- [x] **Step 3: Check the threshold and cancellation states**
...
- [x] **Step 4: Check regression paths**
...
- [x] **Step 5: Check source formatting and repository scope**
