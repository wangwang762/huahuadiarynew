...
for (const marker of [
  "window.HHCloud && window.HHCloud.demo ? demoCases : savedCases",
  "还没有问诊记录",
  "带一盆花来看诊",
...
if (!html.includes("screens-doctor.jsx?v=20260829a")) throw new Error("doctor screen cache version is missing");
